...
{
public:
    SSD1306_I2C(uint nWidth, uint nHeight, const char* szI2CBus, uint8_t addr = 0x3C, bool bExternalVcc = false);
...
private:
    ...
    std::string m_strI2CBus;
    uint8_t m_i2cDeviceAddr;
    int m_i2cDevice;
};
